...
function from(username) {
  return new Promise(function (resolve, reject) {
    db.transaction(
      ...
      () => console.log("7.1 FROM AMOUNT FETCH error"),
      () => console.log("7.1 FROM AMOUNT FETCH SUCCESSFULL")
    );
  });
}
...
function to(username) {
  return new Promise(function (resolve, reject) {
    db.transaction(
      ...
      () => console.log("7.2 TO AMOUNT FETCH error"),
      () => console.log("7.2 TO AMOUNT FETCH SUCCESSFULL")
    );
  });
}
