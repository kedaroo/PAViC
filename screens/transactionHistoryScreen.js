...
export default function TransactionHistoryScreen({ route }) {
  ...
  const refreshTransactions = () => {
    ...
    db.transaction(
      ...
      () => console.log("Fetching TRANSACTION FOR HISTORY error"),
      () => console.log("Fetching TRANSACTION FOR HISTORY SUCCESSFULL")
    );
    setRefreshing(false);
  };
  ...
  return (
    <View style={styles.container}>
      <View style={{ padding: 10, marginTop: 10 }}>
        <Text style={{ color: "#374151", fontSize: 24, fontWeight: "700" }}>
          Recent
        </Text>
        <Text style={{ color: "#374151", fontSize: 38, fontWeight: "700" }}>
          Transactions
        </Text>
      </View>
